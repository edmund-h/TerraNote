...
class FirebaseClient {
    ...
    static func pushNew(note: TNNote)-> TNNote{
        ...
        return TNNote(id: idKey, creator: note.creator, title: note.title, date: note.date, location: note.location, content: note.content, channel: note.channel)
    }
